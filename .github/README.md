...
[`@aws-sdk/client-app-mesh`](https://www.npmjs.com/package/@aws-sdk/client-app-mesh/v/3.1049.0).
...
- @aws-sdk/client-app-mesh v3.1049.0 - [https://cloud-sdk-builds.github.io/?sdk=client-app-mesh&version=3.1049.0](https://cloud-sdk-builds.github.io/?sdk=client-app-mesh&version=3.1049.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-app-mesh@3.1049.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rqEvboTgbZZT9FfceSR4s0V9bHSS5uwgKvQDsdOW7Nns2yPnv4DvpJPiJT2LwBhI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-app-mesh": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-app-mesh@3.1049.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-app-mesh@3.1049.0/index.min.mjs": "sha384-rqEvboTgbZZT9FfceSR4s0V9bHSS5uwgKvQDsdOW7Nns2yPnv4DvpJPiJT2LwBhI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-app-mesh/blob/refs/tags/3.1049.0/LICENSE
```
